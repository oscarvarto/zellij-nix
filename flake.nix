{
  ...
  inputs = {
    ...
    zellij.url = "github:zellij-org/zellij/0e55b270d44ac2f114dd6378044f6f5d94fa4ad7";
    zellij.flake = false;
  };
  ...
  outputs =
    ...
    let
      ...
      version =
        if builtins.isAttrs cargoTOML.package.version && (cargoTOML.package.version.workspace or false) then
