{
  ...
  inputs = {
    ...
    zellij.url = "github:zellij-org/zellij/2035e052f38a738639840a685ddc6a107ea11136";
    zellij.flake = false;
  };
  ...
  outputs = {
    ...
    version =
      if builtins.isAttrs cargoTOML.package.version && (cargoTOML.package.version.workspace or false)
